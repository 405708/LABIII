...
public class Position {
    ...
    /**
     * Este meto-do debe validar si una Position es igual a otro en base a su row y column.
     * Es decir, si esta istancia de Position tiene los mismo datos
     * de row y column del objeto pasado por parametro.
     *
     * @param obj La posicion a comparar contra la instancia en la que se ejecuta el meto-do
     *
