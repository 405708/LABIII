...
/**
 * Esta clase ofrece los meto-dos para controlar la ejecución de multiples partidas.
 *
...
public class BattleShipMatch {
    ...
    /**
     * Este méto-do muestra por pantalla un mensaje de bienvenida al juego de la Batalla Naval
     *
     * @see System#out
     */
    ...
    /**
     * Este méto-do gestiona la creacion del usuario.
    ...
    /**
     * Este meto-do gestiona la creacion del jugador app.
     * Como resultado retorna el Player creado
     *
     * @return un nuevo Player
     */
    ...
    /**
     * Este meto-do controla si el usuario quiere volver a jugar o no.
    ...
    /**
     * Este meto-do propone al jugar abandonar la partida y captura
    ...
    /**
     * Este meto-do valida que el parametro de entrada input contenga y, Y, n o N.
    ...
    private static Boolean getYesNoAnswer(String input) {
        // TOD-O: Crear el objeto Pattern a partir de la expresion regular provista
        Pattern pattern = Pattern.compile(YES_NO_REGEX);
        // TOD-O: Validar si input hace match con la expresion regular
        if(pattern.matcher(input).matches())
        {
            ...
            // TOD-O: Si la respuesta hace match, validar si fue yes (y o Y) o no (n o N)
            // TOD-O: Retornar true si fue yes y, o false si fue no.
        }
        // TOD-O: Si la respuesta NO hace match, mostrar un mensaje de error al usuario y retornar null
