...
public class UserServiceImpl implements UserService {
    ...
    public User createUser(String name, String lastName, String email, String password) {
        // TODO(Completado) 4: Usuario registrado: El sistema deberá permitir a los usuarios registrarse ingresando
        ...
        if (optionalUserEntity.isEmpty()) {
            ...
            userEntitySaved.setName(name);
            userEntitySaved.setLastName(lastName);
            userEntitySaved.setEmail(email);

            return modelMapper.map(userRepository.save(userEntitySaved), User.class);
        }
        else
        {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Email Ya existente");
        }
    }
    ...
    public User getUserByEmail(String email) {
        // TODO(Completado) 4 - Usuario registrado: Crear un método que permita verificar si un email ya existe.
